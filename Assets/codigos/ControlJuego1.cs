...
public class ControlJuego1 : MonoBehaviour
{
    ...
    public logicaJugadorIa logicaJugadorIa;
    public TextMeshProUGUI Score;
    public TextMeshProUGUI Score2;

    public logicaEscena2 perder;
    public logicaPausa1 pausa;
    ...
    private void FinDelJuego()
    {
        ...
        if (CanvasGanar != null)
        {
            ...
            if (logicaJugadorIa != null)
            {
                int puntajeFinal = logicaJugadorIa.puntaje;
